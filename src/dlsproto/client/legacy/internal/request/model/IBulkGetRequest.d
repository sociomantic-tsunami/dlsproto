/*******************************************************************************
    ...
    Base class for Asynchronously/Selector managed DLS bulk get requests
    (GetAll, GetRange, GetAllKeys)

    The bulk DLS commands all return compressed batches of values. This base
...
module dlsproto.client.legacy.internal.request.model.IBulkGetRequest;
...
abstract private class IBulkGetRequest : IChannelRequest, IStreamInfo
{
    ...
    ***************************************************************************/
    ...
    abstract protected void processBatch ( cstring batch );
}
...
abstract public scope class IBulkGetPairsRequest : IBulkGetRequest
{
    ...
    ***************************************************************************/
    ...
    final override protected void processBatch ( cstring batch )
    {
        void receivePair ( cstring value1, cstring value2 )
        {
            this.processPair(value1, value2);
            this.resources.request_suspender.handleSuspension();
        }

        this.resources.record_batch.decompress(cast(ubyte[])batch);
    ...
    ***************************************************************************/
    ...
    abstract protected void processPair ( cstring value1, cstring value2 );
}
...
abstract public scope class IBulkGetValuesRequest : IBulkGetRequest
{
    ...
    ***************************************************************************/
    ...
    final override protected void processBatch ( cstring batch )
    {
        void receiveValue ( cstring value )
        {
    ...
    ***************************************************************************/
    ...
    abstract protected void processValue ( cstring value );
}
