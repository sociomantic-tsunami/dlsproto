/*******************************************************************************
    ...
    Asynchronously/Selector managed DLS GetRangeFilter request class
...
module dlsproto.client.legacy.internal.request.GetRangeFilterRequest;
...
/*******************************************************************************
    ...
    GetRangeFilterRequest class

*******************************************************************************/

public scope class GetRangeFilterRequest : IBulkGetPairsRequest
{
    /**************************************************************************
    ...
    ***************************************************************************/
    ...
    override protected void sendRequestData__ ( )
    {
        ...
        super.writer.writeArray(super.params.filter_string);
    }
